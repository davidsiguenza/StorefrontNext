...
🚧 **Early development — v0.1.0**. Most subcommands are stubs. See [docs/STATUS.md](./docs/STATUS.md) for current progress.

| Phase | Goal | Status |
|---|---|---|
| F1 | Toolkit scaffolding + skill skeleton | ✅ |
| F2 | Patches v0.3 + version drift audit + apply | 🚧 |
| F3 | Crawler ported and cleaned up | ⏳ |
| F4 | Apply branding (write per-client artifacts) | ⏳ |
